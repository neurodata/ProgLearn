...
def experiment(n_task1, n_task2, n_test=1000, 
    ...
    uf = LifelongClassificationForest(default_n_estimators=n_trees)
    ...
    if n_task1 == 0:
        ...
        uf.add_task(X_task1, y_task1, n_estimators=2*n_trees)
        uf.add_task(X_task2, y_task2, n_estimators=2*n_trees)
