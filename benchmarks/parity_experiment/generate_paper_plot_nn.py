...
with open("/Users/jayantadey/ProgLearn/benchmarks/parity_experiment/data/mean_angle_te_with_rep.pickle", "rb") as f:
    te = pickle.load(f)
...
'''with open("/Users/jayantadey/ProgLearn/benchmarks/parity_experiment/data/mean_sample_te100.pickle", "rb") as f:
    te100 = pickle.load(f)
with open("/Users/jayantadey/ProgLearn/benchmarks/parity_experiment/data/mean_sample_te1000.pickle", "rb") as f:
    te1000 = pickle.load(f)'''
with open("/Users/jayantadey/ProgLearn/benchmarks/parity_experiment/data/mean_sample_te100.pickle", "rb") as f:
    te = pickle.load(f)
with open("/Users/jayantadey/ProgLearn/benchmarks/parity_experiment/data/mean_sample_te_nn.pickle", "rb") as f:
