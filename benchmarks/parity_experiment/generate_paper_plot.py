...
n_xor = (100 * np.arange(0.5, 7.75, step=0.25)).astype(int)
n_nxor = (100 * np.arange(0.25, 7.75, step=0.25)).astype(int)
...
ax.text(500, np.mean(ax.get_ylim()) - 0.054, "500", fontsize=labelsize)
