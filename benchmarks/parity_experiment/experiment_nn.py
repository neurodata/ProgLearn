...
def experiment(n_task1, n_task2,  
    ...
    if n_task1 == 0:
        progressive_learner.add_task(X_task2, y_task2, num_transformers=1)
        ...
        progressive_learner.add_task(X_task1, y_task1, num_transformers=1)
        progressive_learner.add_task(X_task2, y_task2, num_transformers=1)

        nn.add_task(X_task1, y_task1, num_transformers=1)
        nn.add_task(X_task2, y_task2, num_transformers=1)
        
        naive_nn_train_x = np.concatenate((X_task1,X_task2),axis=0)
        naive_nn_train_y = np.concatenate((y_task1,y_task2),axis=0)
        naive_nn.add_task(
                naive_nn_train_x, naive_nn_train_y, num_transformers=1
                )
