...
for shift in range(shifts):
    filename = 'result/result/'+model+str(ntrees)+'_'+str(shift+1)+'_base'+'.pickle'
...
plt.savefig('./result/figs/fig_trees'+str(ntrees)+"__"+model+'_base'+'.pdf',dpi=300)
plt.close()
...
plt.tight_layout()
plt.savefig('./result/figs/cifar_timing_results'+'_base'+'.pdf',dpi=300)
