...
from losses import SupervisedContrastiveLoss # adapted version of SupConLoss for ftebte setting, uses cosine similarity matrix
...
def LF_experiment(train_x, train_y, test_x, test_y, ntrees, shift, slot, model, num_points_per_task, acorn=None):
    ...
    file_to_save = 'result/result/'+model+str(ntrees)+'_'+str(shift)+'_SupervisedContrastiveLoss'+'.pickle'
