...
def LF_experiment(train_x, train_y, test_x, test_y, ntrees, shift, slot, model, num_points_per_task, acorn=None):
    ...
    if model == "dnn":
        ...
        network.add(layers.Dense(2000, input_shape=(3*32*32,), activation='relu'))
    ...
    file_to_save = '/Users/jayantadey/ProgLearn/benchmarks/cifar_exp/result_fcc/'+model+'_'+ str(slot)+'_'+str(shift)+'.pickle'
