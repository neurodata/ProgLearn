...
total_alg_top = 4
total_alg_bottom = 4
alg_name_top = ['SynN (0.4)', 'SynN (0.6)', 'SynN (0.8)', 'SynN (1.0)']
alg_name_bottom = ['SynF (0.4)', 'SynF (0.6)', 'SynF (0.8)', 'SynF (1.0)']
combined_alg_name = ['SynN (0.4)', 'SynN (0.6)', 'SynN (0.8)', 'SynN (1.0)', 'SynF (0.4)', 'SynF (0.6)', 'SynF (0.8)', 'SynF (1.0)']
model_file_top = ['dnn0']
