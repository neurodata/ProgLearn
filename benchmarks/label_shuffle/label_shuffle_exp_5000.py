...
def LF_experiment(train_x, train_y, test_x, test_y, ntrees, shift, model, num_points_per_task, acorn=None):
    ...
    for task_ii in range(10):
        ...
        tmp_y = train_y[task_ii*5000:task_ii*5000+num_points_per_task]
        ...
        single_learner.add_task(
            X = train_x[task_ii*5000:task_ii*5000+num_points_per_task],
            y = train_y[task_ii*5000:task_ii*5000+num_points_per_task],
            num_transformers = 1 if model == "dnn" else ntrees,
    ...
    file_to_save = 'result/'+model+str(ntrees)+'_'+str(shift)+'.pickle'
...
#%%
def run_parallel_exp(data_x, data_y, n_trees, model, num_points_per_task, shift=1):
