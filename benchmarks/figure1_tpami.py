...
model_file_top = ['dnn', 'model_zoo','Prog_NN', 'LMC', 'DF_CNN', 'offline', 'exact', 'CoSCL']
...
model_file_combined = ['dnn', 'model_zoo','Prog_NN','DF_CNN', 'LwF', 'offline', 'exact', 'CoSCL', 'agem', 'None']
...
for alg in range(total_alg_top): 
    ...
    for slot in range(slots):
        for shift in range(shifts):
            if alg < 1:
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/result/result/'+model_file_top[alg]+'_'+str(shift)+'_'+str(slot)+'.pickle'
            elif alg == 2 or alg == 4:
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/benchmarking_algorthms_result/'+model_file_top[alg]+'-'+str(shift+1)+'-'+str(slot+1)+'.pickle'
            elif alg == 1:
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/benchmarking_algorthms_result/'+model_file_top[alg]+'_'+str(slot+1)+'_'+str(shift+1)+'.pickle'
            elif alg == 7:
                ...
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/benchmarking_algorthms_result/'+model_file_top[alg]+'-'+str(slot+1)+'-'+str(shift+1)+'.pickle'
...
for alg in range(total_alg_bottom): 
    ...
    for slot in range(slots):
        for shift in range(shifts):
            if alg < 0:
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/result/result/'+model_file_bottom[alg]+'_'+str(shift+1)+'_'+str(slot)+'.pickle'
            else:
                filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/cifar_exp/benchmarking_algorthms_result/'+model_file_bottom[alg]+'-'+str(slot+1)+'-'+str(shift+1)+'.pickle'
...
#     for rep in range(reps):
#         filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/mini_imagenet/results/'+model_file_combined[alg]+'.pickle'
...
#     for rep in range(reps):
#         filename = '/Users/jayantadey/TPAMI_rebuttal/combined_figure/ProgLearn/benchmarks/five_datasets/results/'+model_file_combined[alg]+'.pickle'
...
FLE_yticks = [[-.3,0,.3], [-1.5,0,1], [-.1,0,.4], [-5,0,4]]
BLE_yticks = [[-.4,0,.2], [-3,0,2], [-.3,0,.3], [-7,0,2]]
LE_yticks = [[-.4,0,.2], [-3,0,2], [-.3,0,.4], [-9,0,5]]
acc_yticks = [[0,.5], [0.3,1], [0.2,.6], [0,.2,1]]
