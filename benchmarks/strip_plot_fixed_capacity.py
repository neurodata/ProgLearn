...
total_alg = 8
reps = 1
combined_alg_name = ['SynN*', 'SynN(10)', 'SynN(20)', 'SynN(30)','SynN(40)','SynF*', 'Model Zoo*', 'LwF']
btes = [[] for i in range(total_alg)]
ftes = [[] for i in range(total_alg)]
tes = [[] for i in range(total_alg)]
model_file_combined = ['synn','synn_0fixed_10', 'synn_0fixed_20', 'synn_0fixed_30', 'synn_0fixed_40', 'synf', 'model_zoo', 'LwF']
########################
...
#%%
acc = {'SynN*':np.zeros(50,dtype=float), 'SynN(10)':np.zeros(50,dtype=float), 
       'SynN(20)':np.zeros(50,dtype=float), 'SynN(30)':np.zeros(50,dtype=float),
       'SynN(40)':np.zeros(50,dtype=float), 'SynF*':np.zeros(50,dtype=float), 
       'Model Zoo*':np.zeros(50,dtype=float), 'LwF':np.zeros(50,dtype=float)}
...
df_acc = pd.melt(df_acc,var_name='Algorithms', value_name='Accuracy')
#%%
te = {'SynN*':np.zeros(50,dtype=float), 'SynN(10)':np.zeros(50,dtype=float), 
       'SynN(20)':np.zeros(50,dtype=float), 'SynN(30)':np.zeros(50,dtype=float),
       'SynN(40)':np.zeros(50,dtype=float), 'SynF*':np.zeros(50,dtype=float), 
       'Model Zoo*':np.zeros(50,dtype=float), 'LwF':np.zeros(50,dtype=float)}
...
df_acc.insert(2, "Task ID", task_order)
#%%
bte_end = {'SynN*':np.zeros(50,dtype=float), 'SynN(10)':np.zeros(50,dtype=float), 
       'SynN(20)':np.zeros(50,dtype=float), 'SynN(30)':np.zeros(50,dtype=float),
       'SynN(40)':np.zeros(50,dtype=float), 'SynF*':np.zeros(50,dtype=float), 
       'Model Zoo*':np.zeros(50,dtype=float), 'LwF':np.zeros(50,dtype=float)}
...
fte_end = {'SynN*':np.zeros(50,dtype=float), 'SynN(10)':np.zeros(50,dtype=float), 
       'SynN(20)':np.zeros(50,dtype=float), 'SynN(30)':np.zeros(50,dtype=float),
       'SynN(40)':np.zeros(50,dtype=float), 'SynF*':np.zeros(50,dtype=float), 
       'Model Zoo*':np.zeros(50,dtype=float), 'LwF':np.zeros(50,dtype=float)}
...
clr_labels = ['SynN*',
              ...
              'A-GEM',
              'None']
clr = ['#377eb8', '#377eb8', '#377eb8', '#377eb8', '#377eb8', '#e41a1c', '#4daf4a', '#984ea3', '#83d0c9', '#f781bf', '#b15928', '#e41a1c', '#f781bf', '#f47835', '#b15928', '#8b8589', '#4c516d']
c_ = []
universal_clr_dic = {}
for id in ordr[0]:
    c_.append(clr[id])

for ii, name in enumerate(clr_labels):
    print(name)
