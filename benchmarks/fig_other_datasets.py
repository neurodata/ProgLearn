...
c_ = []
combined_alg_name = ['SiLLy-N*', 'ProgNN*', 'Model Zoo*', 'LMC*', 'CoSCL*', 'DF-CNN*', 'LwF', 'Partial Replay', 'Total Replay', 'A-GEM', 'None']
universal_clr_dic = {}
for id in ordr[0]:
    c_.append(clr[id])
...
datasets = ['spoken digit', 'FOOD1k', 'Split Mini-Imagenet', '5-dataset']
FLE_yticks = [[-1.5,0,1], [-.1,0,.4], [-0.4,0,.6], [-1.5,0,.3]]
BLE_yticks = [[-3,0,2], [-.3,0,.3], [-0.6,0,.2], [-2.5,0,.5]]
LE_yticks = [[-3,0,2], [-.3,0,.4], [-0.6,0,.6], [-2.5,0,.4]]
acc_yticks = [[0.3,1], [0.2,.6], [0,.9], [0,1]]
task_num = [6, 50, 20, 5]
...
clr = [["#377eb8", "#e41a1c", "#4daf4a", "#984ea3", "#984ea3", "#f781bf", "#b15928", "#b15928", "#e41a1c", "#f781bf", "#b15928", "#b15928"],
       ...
       ["#377eb8", "#e41a1c", "#4daf4a", "#f781bf", "#b15928", "#b15928", "#b15928", "#b15928"]]'''
fig, ax = plt.subplots(4,len(tes_all.keys()), figsize=(24,20))
