...
def LF_experiment(num_task_1_data, rep):
    ...
    X_train_task0, y_train_task0 = generate_gaussian_parity(n = num_task_1_data, angle_params = 0)
    X_train_task1, y_train_task1 = generate_gaussian_parity(n = 100, angle_params = 10)
    X_test_task0, y_test_task0 = generate_gaussian_parity(n = 1000, angle_params = 0)
    ...
    single_task_accuracy = np.mean(llf_task == y_test_task0)
    ...
    double_task_accuracy = np.mean(llf_task == y_test_task0)
    double_task_error = 1 - double_task_accuracy
    
    te = single_task_error / double_task_error
...
#%%
num_task_1_data_ra=range(10, 1000, 10)
reps = range(30)
